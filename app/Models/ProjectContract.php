...
class ProjectContract extends Model
{
    ...
    protected $fillable = ['project_id', 'proposal_id', 'freelancer_id', 'employer_id', 'start_date', 'end_date', 'cost', 'total_cost', 'cost_type', 'code', 'is_verify_cde', 'status', 'proposal_type'];
