...
class EmployerController extends Controller
{
    ...
    public function dashboard() {
        ...
        $ongoing_projects = Project::approved()->where('employer_id', $employer->id)->latest('id')->get();
        $completed_projects = Project::completed()->where('employer_id', $employer->id)->latest('id')->get();
        ...
        return view('UserAuthScreens.dashboards.employer', compact('employer', 'recent_workers', 'recent_payments'));
    }
