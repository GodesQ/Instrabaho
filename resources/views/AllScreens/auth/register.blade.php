                            ...
                            <div class="fr-sign-container">
                                <div class="fr-sign-content">
                                    <div class="heading-panel">
                                        ...
                                        <p class="font-weight-bold"> Have an account already? <span><a href="/login"
                                                    class="text-primary">Login here</a></span></p>
                                    </div>
                                    <form id="signup-form" method="POST" novalidate>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold" for="firstname">First name <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" name="firstname" value="{{ old('firstname') }}"
                                                        placeholder="Firstname" class="form-control" maxlength="15">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="middlename" placeholder="Middlename"
                                                        class="form-control" value="{{ old('middlename') }}" maxlength="15">
                                                    <span class="danger text-danger p-1">
                                                        @error('middlename')
                                                            {{ $message }}
                                                        @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="font-weight-bold" for="lastname">Last name <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" name="lastname" placeholder="Lastname"
                                                        class="form-control" value="{{ old('lastname') }}" maxlength="15">
                                                    <span class="danger text-danger p-1">
                                                        @error('lastname')
                                                            {{ $message }}
                                                        @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" placeholder="Username"
                                                class="form-control" value="{{ old('username') }}" maxlength="15">
                                            <span class="danger text-danger p-1">
                                                @error('username')
                                                    {{ $message }}
                                                @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-md-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold" for="email">Password <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-xl-6 col-md-12">
                                                <div class="form-group">
                                                    <label class="font-weight-bold" for="email">Confirm Password <span
                                                            class="text-danger">*</span></label>
                                                    <input type="password" name="password_confirmation"
                                                        placeholder="Confirm Password" class="form-control"
                                                        id="password-field" value="{{ old('password_confirmation') }}">
                                                    <span class="danger text-danger p-1">
