...
@section('content')
                            ...
                            <div class="fr-sign-container" style="margin-top: -40px;">
                                <div class="fr-sign-content">
                                    <div class="heading-panel">
                                        ...
                                        <p class="font-weight-bold"> Don't have an account? <span><a href="/register"
                                                    class="text-primary">Register here</a></span></p>
                                    </div>
                                    <label for="" class="font-weight-bold" style="color: #2e405c">Are you?</label>
                                    <div class="d-flex align-items-center my-1 mb-4">
                                        <div class="px-4 py-3 border mr-50 cursor-pointer d-flex align-items-center justify-content-around rounded active-role"
                                            onclick="selectRole(this, 'freelancer')">
                                            ...
                                            <div class="text-center role" style="color: #000; font-weight: 800;">Freelancer
                                            </div>
                                            {{-- <div class="text-center" style="color: #000; font-size: 10px;">Looking for dream projects</div> --}}
                                        </div>
                                        <div class="px-5 py-3 border ml-50 cursor-pointer d-flex align-items-center justify-content-center rounded"
                                            onclick="selectRole(this, 'employer')">
                                            ...
                                            <div class="text-center role" style="color: #000; font-weight: 800;">Client
                                            </div>
                                    ...
                                    <form id="signup-form" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" placeholder="" class="form-control"
                                                data-smk-msg="Email address is required" value="">
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="font-weight-bold">Password</label>
                                            <input type="password" name="password" placeholder="Password"
                                                class="form-control" id="password-field"
                                                data-smk-msg="Please provide password" value="">
                                        </div>
                                        <div class="fr-sigin-requirements">
                                            <a href="#" data-bs-toggle="modal" class="text-primary"
                                                data-bs-target="#forget_pwd"> <span> Forgot Password</span></a>
                                        </div>
    ...
    <div class="modal fade forget_pwd show" id="forget_pwd" tabindex="-1" role="dialog" aria-labelledby="forget_pwd"
        aria-modal="true">
                ...
                <div class="modal-body">
                    <form id="fl-forget-form" method="POST" action="/send_forgot_form">
                        ...
                        <div class="fr-sign-form">
                            <div class="fr-sign-logo"> <img
                                    src="https://marketplace.exertiowp.com/wp-content/themes/exertio/images/icons/mail.png"
                                    alt="" class="img-fluid"> </div>
                            <div class="form-group">
                                <input type="email" name="email" placeholder="Registered email address"
                                    class="form-control" required=""
                                    data-smk-msg="Please provide valid registered email address">
                            </div>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-theme btn-block btn-loading" id="forget_btn">Recover now
                                <span class="bubbles"> <i class="fa fa-circle" aria-hidden="true"></i> <i
