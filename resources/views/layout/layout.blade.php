    ...
    <div class="fr-menu sb-header header-shadow viewport-lg exer-menu">
        <div class="container">
            ...
            <div class="sb-header-container">
                <!--Logo-->
                <div style="width: 170px;" class="logo" data-mobile-logo="../../../images/logo/main-logo.png"
                    data-sticky-logo="../../../images/logo/main-logo.png">
                    <a href="/"><img style="width: 100%;" src="../../../images/logo/main-logo.png"
                            alt="" /></a>
                </div>
                <!-- Burger menu -->
                ...
                <nav class="sb-menu menu-caret submenu-top-border submenu-scale">
                    <ul>
                        ...
                        @if ((!Session::get('role') && !Session::get('id')) || !in_array(Session::get('role'), $user_role))
                            <li class="fr-list">
                                <a href="/register" class="btn-theme-warning style-1"
                                    style="padding: 0.7rem 1rem !important;">
                                    Register
                                </a>
                                <a href="/login" class="btn btn-theme" style="padding: 0.7rem 1rem !important;">Sign
                                    in</a>
                            </li>
                        @else
                            <li class="dropdown dropdown-user nav-item fr-list loggedin">
                                <a class="dropdown-toggle nav-link dropdown-user-link d-flex justify-content-between align-items-center"
                                    href="#" data-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        @if (Session::get('profile_image'))
                                            <img class="brand-text"
                                                style="width: 30px; height: 30px; object-fit: cover;"
                                                src="../../../images/user/profile/{{ Session::get('profile_image') }}"
                                                alt="Avatar Image">
                                        @else
                                            <img class="brand-text" src="../../../images/user-profile.png"
                                                style="width: 30px; height: 30px; object-fit: cover;"
                                                alt="Avatar Image">
                                        @endif
                                    </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-right p-3" style="width: 300px;">
                                    ...
                                    <a href="/{{ session()->get('role') == 'freelancer' ? 'freelancer' : 'employer' }}/dashboard"
                                        class="dropdown-item" style="color: #000000 !important;">
                                        <i class="fa fa-home"></i> Dashboard
                                    </a>
                                    <a href="{{ session()->get('role') == 'freelancer' ? route('freelancer.profile') : route('employer.profile') }}"
                                        class="dropdown-item" style="color: #000000 !important;">
                                        <i class="fa fa-user"></i> Edit Profile
                                    </a>
                                    <a class="dropdown-item" href="/change_login"
                                        style="color: #000000 !important;"><i class="feather icon-log-in"></i> Login
                                        as {{ session()->get('role') == 'employer' ? 'Freelancer' : 'Emloyer' }}</a>
        ...
        <div class="container">
            <div class="row py-5 align-items-center" style="border-bottom: 1px solid #fff;">
                <div class="col-12 col-lg-6">
                    <h1 style="color: #fff !important;">Start Working <br> with <span
                            style="color: #04bbff;">Instrabaho</span> Today</h1>
                </div>
            ...
            <div class="row padding-bottom-60 py-5" style="border-bottom: 1px solid #fff;">
                <div class="col-xxl-4 col-xl-3 col-lg-12 col-12 col-sm-12 col-md-12">
                    <div class="fr-footer-details fr-footer-content">
                        <img src="../../../images/logo/main-logo.png" alt="" class="img-fluid" />
                ...
                <div class="col-xxl-2 col-lg-4 col-xl-3 col-xs-12 col-sm-6 col-md-4">
                    <div class="fr-footer-content">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="/search_freelancers">Freelancers Search</a>
                            </li>
                            <li>
