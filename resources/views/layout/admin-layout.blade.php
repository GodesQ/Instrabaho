        ...
        <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
            <div class="main-menu-content">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li><a class="menu-item" href="#" data-i18n="Freelancer"><i class="feather icon-bookmark"></i> Saved Jobs</a>
                        <ul class="menu-content">
                            <li>
                    ...
                    <li class=" navigation-header"><span>REPORTS</span><i class=" feather icon-minus" data-toggle="tooltip" data-placement="right" data-original-title="REPORTS"></i>
                    </li>
                    <li class=" nav-item"><a href="#"><i class="icon-graph"></i><span class="menu-title" data-i18n="Sales Report">Sales Report</span></a>
                        <ul class="menu-content">
                            <li class="">
                    ...
                    <li class=" nav-item"><a href="#"><i class="icon-graph"></i><span class="menu-title" data-i18n="Jobs Report">Jobs Report</span></a>
                        <ul class="menu-content">
                            <li class="">
                    ...
                    <li class="{{ Request::path() == '/admin/services' ? 'active' : '' }} nav-item">
                        <a href="/admin"><i class="feather icon-grid"></i>
                            <span class="menu-title" data-i18n="Active Employer Reports">Active Employer Reports</span>
                        </a>
                    </li>
                    <li class="{{ Request::path() == '/admin/services' ? 'active' : '' }} nav-item">
                        <a href="/admin"><i class="feather icon-grid"></i>
                            <span class="menu-title" data-i18n="Active Freelancer Reports">Active Freelancer Reports</span>
                        </a>
                    </li>
