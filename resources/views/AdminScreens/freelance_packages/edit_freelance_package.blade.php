            ...
            <div class="container">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Update Freelance Package</div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.freelancer_packages.update') }}" method="POST">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label font-weight-bold">Total Create Service</label>
                                        <input type="number" name="total_services" value="{{ $package->total_services }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label font-weight-bold">Total Create Featured Service</label>
                                        <input type="text" name="total_feature_services" value="{{ $package->total_feature_services }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="form-footer float-right">
                                <a href="/admin/freelancer_packages" class="btn btn-outline-secondary">Cancel</a>
