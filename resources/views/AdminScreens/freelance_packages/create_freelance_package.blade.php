            ...
            <div class="container">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Create Freelance Package</div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.freelancer_packages.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="total_services" value="" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="total_feature_services" value="" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
