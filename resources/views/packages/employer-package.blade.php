          ...
          <div class="col-xl-12 col-lg-12 col-sm-12 col-md-12 col-xs-12">
             <div class="fr-list-content">
                <div class="fr-list-srch">
                   <h1>Employer Packages</h1>
                </div>
                <div class="fr-list-details">
                   <ul>
                      <li><a href="/">Home</a></li>
                      <li><a href="javascript:void(0)">Employer Packages</a></li>
                   </ul>
                </div>
             </div>
          </div>
                     ...
                     <div class="col-xl-3 col-sm-6 col-md-6 col-xs-12 col-lg-4">
                        <div class="fr-plan-basics {{ $package->name != 'Business' ? ' fr-plan-basics-2' : null }}">
                           <div class="fr-plan-content">
                              ...
                              <input type="text" class="employer_package_nonce" value="704ced3502" hidden="">
                           </div>
                           <div class="fr-plan-details">
                              <ul>
                                 ...
                                 <li><i class="fa fa-check" aria-hidden="true"></i>{{ $package->name == 'The Unli' ? 'Unlimited' : $package->total_feature_projects }} Featured Projects</li>
