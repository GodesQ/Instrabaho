...
@section('content')
    ...
    <section class="fr-hero-theme add-bg-img">
        @if ($freelancer->user->cover_image)
            <img width="100%" height="250" style="object-fit: cover; object-position: center;"
                src="../../../images/user/cover/{{ $freelancer->user->cover_image }}" alt="">
        @else
            <img width="100%" height="250" style="object-fit: cover; object-position: center;"
                src="../../../images/bg-image/default-cover.png" alt="">
        @endif
    </section>
                ...
                <div class="col-lg-9 col-xl-9 col-xs-12 col-md-9 col-sm-12">
                    <div class="fr-hero-details-content">
                        ...
                        <div class="fr-hero-details-information">
                            <span class="title"><i
                                    class="fa fa-check add-weight"></i>{{ $freelancer->display_name }}</span>
                            <h1 class="name">{{ $freelancer->tagline }}</h1>
                            <div class="fr-hero-m-deails">
                                <ul>
                                    <li> <span> Member since
                                            {{ date_format(new DateTime($freelancer->created_at), 'F d, Y') }}</span> </li>
                                    <li>
                                        <span class="primary mr-25">{{ number_format($freelancer->rate, 1) }}</span>
                                        @for ($i = 0; $i < round($freelancer->rate); $i++)
                                            <i class="fas fa-star" style="color: #04bbff !important;"
                                                aria-hidden="true"></i>
                                        @endfor
                                    </li>
                                </ul>
                        ...
                        <div class="fr-hero-short-list-2">
                            <div class="fr-hero-hire-content">
                                @if (session()->get('role') == 'employer')
                                    <a href="/follow_freelancer/view/{{ $freelancer->id }}"
                                        class="follow-freelancer protip" data-fid="171" data-pt-position="top"
                                        data-pt-scheme="black" data-pt-title="Follow Freelancer">
                ...
                <div class="col-lg-12 col-xl-12 col-xs-12 col-md-12 col-sm-12">
                    <div class="fr-hero-m-jobs-bottom">
                        <ul>
                            ...
                            <li> <span><small>{{ $freelancer->projects_completed()->count() }}</small> Completed
                                    Projects</span> </li>
                            <li> <span><small>0</small> Completed Services</span> </li>
                            <li> <span><small>{{ $freelancer->total_reviews }}</small>
                                    {{ $freelancer->total_reviews > 1 ? 'Reviews' : 'Review' }}</span> </li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="fr-product-description padding-bottom-80">
      ...
      <a href="index.html"><img src="img/top-trending-imgs/exertio-elementor.jpg" alt="exertio theme" class="img-fluid"></a>
                                    ...
                                    <li>
                                        ...
                                        <div class="figcaption">
                                            <h6><a href="{{ $project->project_url }}"
                                                    target="_blank">{{ $project->project_name }}</a></h6>
                                        </div>
                                    </li>
                                @empty
                                    <div class="heading-contents">
                                ...
                                <div class="fr-expertise-product">
                                    ...
                                    <div class="fr-expertise-details">
                                        ...
                                        <ul class="experties-meta">
                                            ...
                                            <li>
                                                <span>
                                                    {{ date_format(new DateTime($experience->start_date), 'F d, Y') }} -
                                                    {{ !$experience->end_date ? 'Current' : date_format(new DateTime($experience->start_date), 'F d, Y') }}</span>
                                            </li>
                                        </ul>
                                        <p>
                                ...
                                <div class="fr-expertise-product">
                                    ...
                                    <div class="fr-expertise-details">
                                        ...
                                        <ul class="experties-meta">
                                            ...
                                            <li>
                                                <span>
                                                    {{ date_format(new DateTime($education->start_date), 'F d, Y') }} -
                                                    {{ !$education->end_date ? 'Current' : date_format(new DateTime($education->start_date), 'F d, Y') }}</span>
                                            </li>
                                        </ul>
                                        <p>
                                        ...
                                        <div>
                                            <span>
                                                @for ($i = 0; $i < $review->freelancer_rate; $i++)
                                                    <i class="fas fa-star"
                                                        style="color: #04bbff !important; font-size: 8px;"
                                                        aria-hidden="true"></i>
                                                @endfor
                                            </span>
                                        </div>
                    ...
                    <div class="fl-advert-box">
                        <a href="/"><img class="brand-text" alt="stack admin logo"
                                src="../../../images/logo/main-logo.png" style="width: 140px;"></a>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                        ...
                        <div class="fr-recent-certification sidebar-box">
                            ...
                            <ul>
                                @forelse($freelancer->certificates as $certificate)
                                    <li>
                                        <div class="fr-recent-us-profile"><a target="_blank" data-fancybox="awards"
                                                href="../../../images/freelancer_certificates/{{ $certificate->certificate_image }}">
                                                <img src="../../../images/freelancer_certificates/{{ $certificate->certificate_image }}"
                                    ...
                                    <li>
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar bg-primary"
                                                style="width: {{ $skill->skill_percentage }}% !important;"
                                                role="progressbar" aria-valuenow="{{ $skill->skill_percentage }}"
                    ...
                    <p class="report-button text-center"> <a href="#" data-bs-toggle="modal"
                            data-bs-target="#report-modal"><i class="fas fa-exclamation-triangle"></i>Report
                            Freelancer</a></p>
                </div>
            </div>
        </div>
