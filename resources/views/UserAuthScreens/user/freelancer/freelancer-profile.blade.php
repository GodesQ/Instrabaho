            ...
            <div class="col-md-4 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="h2">{{ $freelancer->user->firstname }} {{ $freelancer->user->lastname  }}</div>
