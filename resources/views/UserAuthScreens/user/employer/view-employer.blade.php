    ...
    <section class="fr-hero-theme">
        @if ($employer->user->cover_image)
            <img width="100%" height="250" style="object-fit: cover; object-position: center;"
                src="../../../images/user/cover/{{ $employer->user->cover_image }}" alt="">
        @else
            <img width="100%" height="250" style="object-fit: cover; object-position: center;"
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-5 col-sm-5 align-self-center">
                            @if (session()->get('role') == 'freelancer')
                                <div class="fr-expert-content">
                                    <a href="/freelancer/follow_employer/{{ $employer->id }}"
                                        class="btn btn-danger follow-employer" data-emp-id="804"><i class="fa fa-heart"></i>
                                        {{ $follow_employer ? 'Unfollow' : 'Follow' }}</a>
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-xl-4 col-md-12 col-xs-12 col-sm-12">
                    <div class="fr-c-details">
                        <div class="fr-c-detail-box">
                            <div class="fl-profile-img">
                                @if ($employer->user->profile_image)
                                    <img src="../../../images/user/profile/{{ $employer->user->profile_image }}"
                                        alt="" class="img-fluid">
                                @else
                                    <img src="../../../images/user-profile.png" alt="" class="img-fluid">
                                @endif
                            </div>
                            <p><i class="fa fa-check protip" data-pt-position="top" data-pt-scheme="black"
                                    data-pt-title=" Verified" aria-hidden="true"></i>{{ $employer->display_name }}</p>
                        ...
                        <div class="fr-c-social-icons">
                            <ul>
                                <li> <a href="{{ $employer->facebook_url }}" target="_blank"><i
                                            class="feather icon-facebook"></i></a> </li>
                                <li> <a href="{{ $employer->twitter_url }}" target="_blank"><i
                                            class="feather icon-twitter"></i></a> </li>
                                <li> <a href="{{ $employer->linkedin_url }}" target="_blank"><i
                                            class="feather icon-linkedin"></i></a> </li>
                            </ul>
                        </div>
                    </div>
                    <p class="report-button text-center"> <a href="#" data-bs-toggle="modal"
                            data-bs-target="#report-modal"><i class="fas fa-exclamation-triangle"></i>Report Employer</a>
                    </p>
                            ...
                            <div class="fr-right-detail-box">
                                <div class="fr-right-detail-content">
                                    <div class="fr-right-details-products">
                                        <div class="fr-jobs-price">
                                            ...
                                            <p class="price_type protip"
                                                data-pt-title="For 80 hours total will be  $1,600.00" data-pt-position="top"
                                                data-pt-scheme="black">Hourly <i class="far fa-question-circle"></i></p>
                                        </div>
                                        <div class="fr-right-details2">
                                            <a
                                                href="/projects/{{ $completed_project->id }}/{{ $completed_project->title }}">
                                ...
                                <div class="fr-right-information">
                                    ...
                                    <div class="fr-right-bid">
                                        <ul>
                                            <li><a href="/projects/{{ $completed_project->id }}/{{ $completed_project->title }}"
                                                    class="btn btn-theme">View Detail</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
