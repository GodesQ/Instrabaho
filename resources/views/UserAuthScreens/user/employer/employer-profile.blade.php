                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 my-50 d-flex justify-content-center align-items-center">
                                    <div
                                        class="icon bg-primary d-flex justify-content-center align-items-center icon-con-circle">
                        ...
                        <div class="card-body">
                            <div class="cover-image">
                                @if ($employer->user->cover_image)
                                    <img src="../../../images/user/cover/{{ $employer->user->cover_image }}"
                                        alt="">
                                @else
                            ...
                            <form class="form" enctype="multipart/form-data" method="POST" action="/change_user_picture">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="new_profile_picture"
                                            id="inputGroupFile01">
                                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                                    </div>
                                    <input type="hidden" name="old_profile_picture" id=""
                                        value="{{ $employer->user->profile_image }}">
                                    <span style="font-style: italic; font-size: 10px;">Leave it empty if you want the
                                        current photo.</span>
                                </div>
                                <div class="form-group">
                                    <div class="form-label font-weight-bold my-50">Change Cover Photo</div>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="new_cover_picture"
                                            id="inputGroupFile01">
                                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                                    </div>
                                    <input type="hidden" name="old_cover_picture" id=""
                                        value="{{ $employer->user->cover_image }}">
                                    <span style="font-style: italic; font-size: 10px;">Leave it empty if you want the
                                        current photo.</span>
                                </div>
