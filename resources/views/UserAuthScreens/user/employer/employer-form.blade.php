            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="firstname" value="{{ $employer->user->firstname }}"
                            class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="username" value="{{ $employer->user->username }}"
                            class="form-control">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="display_name" value="{{ $employer->display_name }}"
                            class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="number_employees" id="" class="custom-select form-control">
                            ...
                            <option value="0" {{ $employer->number_employees == '0' ? 'selected' : null }}>0
                                Employee</option>
                            <option value="1-10" {{ $employer->number_employees == '1-10' ? 'selected' : null }}>1 -
                                10 Employees</option>
                            <option value="11-20" {{ $employer->number_employees == '11-20' ? 'selected' : null }}>11
                                - 20 Employees</option>
                            <option value="21-30" {{ $employer->number_employees == '21-30' ? 'selected' : null }}>21
                                - 30 Employees</option>
                            <option value="31-50" {{ $employer->number_employees == '31-50' ? 'selected' : null }}>31
                                - 50 Employees</option>
                            <option value="50+" {{ $employer->number_employees == '50+' ? 'selected' : null }}>More
                                than 50</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="row d-none">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="latitude" value="{{ $employer->latitude }}"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="facebook_url" value="{{ $employer->facebook_url }}"
                            class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="instagram_url" value="{{ $employer->instagram_url }}"
                            class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="dribble_url" value="{{ $employer->dribble_url }}"
                            class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="behance_url" class="form-control"
                            value="{{ $employer->behance_url }}">
                    </div>
                </div>
            </div>
