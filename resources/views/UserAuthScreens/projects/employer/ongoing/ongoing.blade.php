                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul>
                                        <li><i class="fa fa-calendar mr-1"></i> Start Date : <span class="font-weight-bold">{{ $data->contract->start_date ? date_format(new DateTime($data->contract->start_date), 'F d, Y') : 'No Start Date' }}</span></li>
                                        <li><i class="fa fa-calendar mr-1"></i> End Date : <span class="font-weight-bold">{{ $data->contract->end_date ? date_format(new DateTime($data->contract->end_date), 'F d, Y') : 'No End Date' }}</span></li>
                                    </ul>
                                    <div class="text-right">
                                        <a href="/project/contract/view/{{ $data->contract->id }}" class="info mx-50">View Contract</a>
