                        ...
                        <div class="row">
                            ...
                            @foreach ($project_images as $key => $image)
                                <div class="col-lg-1 col-md-2 col-sm-3">
                                    <img src="../../../images/projects/{{ $image }}" alt="attachment"
                                        class="my-75" width="100"> <br>
                                    <a href="#" id="{{ $key }}"
                                        class="remove-attachment btn btn-sm btn-danger">Remove</a>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form action="{{ route('project.update') }}" id="create-project" method="POST"
                                        ...
                                        <fieldset class="my-3">
                                                ...
                                                <div class="row gap-2">
                                                    @foreach ($categories as $category)
                                                        <div onclick="selectCategory(this)"
                                                            class="{{ $category->id == $project->category_id ? 'active-category' : null }} categories border p-2 col-lg-2 m-1 d-flex justify-content-center align-items-center cursor-pointer flex-column"
                                            ...
                                            <input type="hidden" name="category_id"
                                                value="{{ $project->category_id }}" id="category_id">
                                        </fieldset>

                                        <h6>Project Schedule</h6>
                                        <fieldset class="my-3">
                                            <div class="form-label font-weight-bold my-50">When do you need to complete
                                                this project?</div>
                                            <div class="form-group">
                                                <div class='input-group'>
                                                    <input type='text' class="form-control datetime" name="datetime"
                                                        value="{{ $project->datetime }}" readonly />
                                        ...
                                        <fieldset>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="title"
                                                            id="project" required value="{{ $project->title }}"
                                                            maxlength="255">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="skills[]" id="" multiple
                                                            ...
                                                            @foreach ($skills as $skill)
                                                                <option
                                                                    {{ in_array($skill->id, $project->skills) ? 'selected' : null }}
                                                                    value="{{ $skill->id }}">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <div class="form-label my-1 font-weight-bold">Description
                                                            </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="project_type" id=""
                                                            ...
                                                            <option
                                                                {{ $project->project_type == 'Simple' ? 'selected' : null }}
                                                                value="Simple">Simple</option>
                                                            <option
                                                                {{ $project->project_type == 'Featured' ? 'selected' : null }}
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <div
                                                            ...
                                                            <button type="button" class="btn btn-primary"
                                                                id="get-current-location">Get Current Location</button>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6 d-none">
                                                        <div class="form-group d-none">
                                                            <div class="form-label font-weight-bold my-50">Longitude
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2 form-control" id="payment_method"
                                                            ...
                                                            <optgroup label="Instrabaho Wallet">
                                                                <option value="my-wallet"
                                                                    {{ $project->payment_method == 'my-wallet' ? 'selected' : null }}>
                                                                    My Wallet</option>
                                                            </optgroup>
                                                            <optgroup label="E-WALLETS">
                                                                <option value="gcash"
                                                                    {{ $project->payment_method == 'gcash' ? 'selected' : null }}>
                                                                    GCASH</option>
                                                                <option value="grabpay"
                                                                    {{ $project->payment_method == 'grabpay' ? 'selected' : null }}>
                                                                    GrabPay</option>
                                                                <option value="maya"
                                                                    {{ $project->payment_method == 'maya' ? 'selected' : null }}>
                                                                    Maya</option>
                                                            </optgroup>
                                                            <optgroup label="Online Banking">
                                                                <option value="bpi"
                                                                    {{ $project->payment_method == 'bpi' ? 'selected' : null }}>
                                                                    BPI BANK</option>
                                                            </optgroup>
