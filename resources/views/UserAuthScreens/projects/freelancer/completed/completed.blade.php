                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-6">
                            <div class="card" style="height: 195px;">
                                <div class="card-body">
                                    ...
                                    <p>{{ strlen($completed_project->project->description) > 100 ? substr($completed_project->project->description, 0, 100) . '...' : $completed_project->project->description }}
                                    </p>
                                    <div class="text-right">
                                        ...
                                        @if (!$completed_project->contract->is_freelancer_review)
                                            <a href="/review_employer/project/{{ $completed_project->contract->id }}"
