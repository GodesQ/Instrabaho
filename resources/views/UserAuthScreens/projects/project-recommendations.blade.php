                    ...
                    <div class="d-flex justify-content-center align-items-center flex-column">
                        <a href="/freelancers/{{ $freelancer->user->username }}" class="freelancer-image img-fluid">
                            <img src="../../../images/user/profile/{{ $freelancer->user->profile_image }}"
                                alt="{{ $freelancer->user->profile_image }} Image"
                                style="object-fit: cover; height: 150px; width: 150px; border-radius: 50%;">
                        </a>
                        ...
                        <div class="text-center font-weight-bold">Distance :
                            {{ number_format($freelancer->distance, 2) }} km</div>
                    </div>
