    ...
    @forelse ($proposals as $proposal)
        <div class="d-flex justify-content-center my-1">
            <div class="container" style="width: 95% !important;">
                <div class="d-xl-flex p-2" style="gap: 20px; box-shadow: 1px 0px 20px rgb(0 0 0 / 7%); position: relative !important; background: #fff;">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            ...
                            @if ($proposal->status == 'pending')
                                <a href="/project/create-contract/proposal/{{ $proposal->id }}" class="btn btn-success">Hire</a>
                            @endif
                        </div>
                    </div>
                    <div class="badge badge-{{$proposal->status == 'approved' ? 'success' : 'primary'}} position-absolute" style="top: 10px; right: 20px;">
                        {{ $proposal->status }}
                    </div>
                </div>
            </div>
