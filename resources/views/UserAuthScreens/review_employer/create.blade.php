                ...
                <div class="container">
                    ...
                    <div class="card my-1">
                        <div class="card-body">
                            <div class="review-header">
                                <div class="d-flex justify-content-start align-items-center flex-sm-row" style="gap: 10px;">
                                    @if ($contract->employer->user->profile_image)
                                        <img class="border-primary employer-image"
                                            src="../../../images/user/profile/{{ $contract->employer->user->profile_image }}"
                                            alt="">
                                    @else
                                        <img class="border-primary employer-image" src="../../../images/user-profile.png"
                                            alt="">
                                    @endif
                                    <div class="review-header-content">
                                        <h4 class="font-weight-bold">{{ $contract->employer->user->firstname }}
                                            {{ $contract->employer->user->lastname }}</h4>
                            ...
                            <form action="{{ route('post-review.employer') }}" method="POST"
                                    ...
                                    <div class="rate-container my-25">
                                        <div class="d-md-flex justify-content-start align-items-center">
                                            ...
                                            <div class="ratings mx-2">
                                                <div class="employer-star star" id="1"
                                                    style="color: rgb(255, 166, 0);">&#9734;</div>
                                                <div class="employer-star star" id="2"
                                                    style="color: rgb(255, 166, 0);">&#9734;</div>
                                                <div class="employer-star star" id="3"
                                                    style="color: rgb(255, 166, 0);">&#9734;</div>
                                                <div class="employer-star star" id="4"
                                                    style="color: rgb(255, 166, 0);">&#9734;</div>
                                                <div class="employer-star star" id="5"
                                                    style="color: rgb(255, 166, 0);">&#9734;</div>
                                            </div>
