                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <h4 class="text-right">₱ {{ number_format($saved_project->project->cost, 2) }}
                                            </h4>
                                    ...
                                    <div style="font-size: 12px; color: gray;" class="my-1">
                                        {{ substr($saved_project->project->description, 0, 150) . '...' }}</div>
                                    <div class="d-flex justify-content-end" style="gap: 10px;">
                                        <a href="/project/{{ $saved_project->project->id }}#fr-bid-form"
                                            class="btn btn-sm btn-primary p-50">Send Proposal</a>
                                        <form action="{{ route('saved_project.destroy', $saved_project->id) }}"
                                            method="post">
                                            @method('DELETE')
                                            @csrf
                                            <button class="btn btn-sm btn-danger p-50"><i class="feather icon-x"></i>
                                                Unsaved</button>
                                        </form>
                                    </div>
                                </div>
