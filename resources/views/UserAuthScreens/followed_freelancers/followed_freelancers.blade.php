                            ...
                            <tbody>
                                @forelse($followed_freelancers as $followed_freelancer)
                                    <tr style="border-bottom: 1px solid #e3ebf3;">
                                        <td width="40%">
                                            <div class="d-flex justify-content-start align-items-center" style="gap: 10px;">
                                                @if($followed_freelancer->freelancer->user->profile_image)
                                                    <img style="border-radius: 50px;" src="../../../images/user/profile/{{ $followed_freelancer->freelancer->user->profile_image }}" alt="" width="40">
                                                @else
                                                    <img style="border-radius: 50px;" src="../../../images/user-profile.png" alt="" width="40">
                                                @endif
                                                <div>
                                                    <div class="font-weight-bold">{{ $followed_freelancer->freelancer->display_name }}</div>
                                        ...
                                        <td>
                                            <a href="/freelancer/view/{{ $followed_freelancer->freelancer->display_name }}" class="btn btn-sm btn-outline-primary"><i class="fa fa-eye"></i></a>
