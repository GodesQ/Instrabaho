    ...
    <div class="row">
        <div class="col-md-5">
            <div class="card rounded">
                <div class="card-body">
                    @php $attachments = json_decode($purchased_service->service->attachments); @endphp
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            @foreach ($attachments as $key => $attachment)
                                <li data-target="#carousel-example-generic {{ $loop->first ? 'active' : null }}"
                        ...
                        <div class="carousel-inner" role="listbox">
                            @foreach ($attachments as $attachment)
                                <div class="carousel-item {{ $loop->first ? 'active' : null }}">
                                    <img src="../../../images/services/{{ $attachment }}"
                                        style="
                    ...
                    <div class="container-fluid my-1">
                        ...
                        <div class="row my-2">
                            <div class="col-lg-12">
                                ...
                                <div class="my-1">
                                    <span class="text-primary">Estimated Date:</span>
            ...
            <div class="wrapper">
                <section class="chat-area">
                    <header class="d-flex justify-content-between align-items-center header">
                        <div style="width: 60%" class="d-flex align-items-center header-content">
                            <a href="/purchased_service/ongoing" class="back-icon"><i class="fa fa-arrow-left"></i></a>
                        ...
                        @if (session()->get('role') == 'employer')
                            <div style="width: 40%; text-align: right" class="header-content header-content-buttons">
                    ...
                    <form action="#" class="typing-area">
                        @csrf
                        <input type="hidden" value="{{ $purchased_service->id }}" id="msg_id" name="msg_id" />
                        <input type="text" class="incoming_id" name="incoming_id" value="{{ $incoming_msg_id }}"
                            hidden />
                        <input type="text" class="outgoing_id" name="outgoing_id" value="{{ $outgoing_msg_id }}"
                            hidden />
