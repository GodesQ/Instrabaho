                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="border-bottom d-lg-flex justify-content-between px-2 my-2">
                                        ...
                                        <input type="hidden" name="job_cost" id="job_cost"
                                            value="{{ $job_data['cost'] }}">
                                    </div>
                                    <div class="container-fluid">
                                        <div class="row my-2">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <ul class="list-group my-1">
                                                    <li
                                                        ...
                                                        <fieldset>
                                                            <input type="radio" name="payment_method"
                                                                class="payment_method mr-2" value="pay_using_wallet"
                                                                id="input-radio-20">
                                                    ...
                                                    <li
                                                        ...
                                                        <fieldset>
                                                            <input type="radio" name="payment_method"
                                                                class="payment_method mr-2" value="gcash"
                                                                id="input-radio-14">
                                                    ...
                                                    <li
                                                        ...
                                                        <fieldset>
                                                            <input type="radio" name="payment_method"
                                                                class="payment_method mr-2" value="grab_pay"
                                                                id="input-radio-17">
                                                    ...
                                                    <li
                                                        ...
                                                        <fieldset>
                                                            <input type="radio" name="payment_method"
                                                                class="payment_method mr-2" value="paymaya"
                                                                id="input-radio-15">
                                                            <label for="input-radio-15">PAYMAYA</label>
                                                        </fieldset>
                                                        <img src="../../../images/logo/paymaya-logo.png"
                                                            style="width: 50px;">
                                                    </li>
                                                    ...
                                                    <li
                                                        ...
                                                        <fieldset>
                                                            <input type="radio" name="payment_method"
                                                                class="payment_method mr-2" value="card"
                                                                id="input-radio-16">
                                            ...
                                            <div class="col-md-12">
                                                <div class="card" id="cc_form"
                                                    style="box-shadow: 1px 0px 20px rgb(0 0 0 / 7%) !important; background: #fff; display: none;">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        placeholder="Card Holder" name="card_holder">
                                                                    <span class="text-danger danger">
                                                                        @error('card_holder')
                                                                            {{ $message }}
                                                                        @enderror
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        data-mask="0000000000000000" name="card_number">
                                                                    <span class="text-danger danger">
                                                                        @error('card_number')
                                                                            {{ $message }}
                                                                        @enderror
                                                            ...
                                                            <div class="col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        data-mask="000" placeholder="000" name="cvc">
                                                                    <span class="text-danger danger">
                                                                        @error('cvc')
                                                                            {{ $message }}
                                                                        @enderror
                        ...
                        <div class="col-md-5">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="container-fluid">
                                        <div
                                            class="d-lg-flex justify-content-between align-items-center font-weight-normal my-50">
                                        ...
                                        <div
                                            ...
                                            <h4>₱ <span
                                                    class="job_cost_display">{{ number_format($job_data['cost'], 2) }}</span>
                                            </h4>
                                        </div>
                                        <div
                                            class="d-lg-flex justify-content-between align-items-center font-weight-normal my-50">
                                        ...
                                        <div
                                            ...
                                            <h4>₱ <span
                                                    class="total_display">{{ number_format($job_data['cost'], 2) }}</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    ...
                                    <a class="btn btn-secondary float-right mx-50"
                                        href="{{ $job_data['job_type'] == 'project' ? '/employer/projects/ongoing' : null }}">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
