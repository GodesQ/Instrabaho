                ...
                <div class="container-fluid">
                    <ul class="nav nav-tabs nav-underline no-hover-bg" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="base-tab33" data-toggle="tab" aria-controls="tab33" href="#tab33"
                                role="tab" aria-selected="false">Approved Offers</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="base-tab34" data-toggle="tab" aria-controls="tab34" href="#tab34"
                                role="tab" aria-selected="false">Calendar</a>
                        </li>
                    </ul>
                    <div class="tab-content px-1 pt-1">
                                                    ...
                                                    @foreach ($service_images as $key => $image)
                                                        <div class="col-lg-1 col-md-2 col-sm-3">
                                                            <img src="../../../images/services/{{ $image }}"
                                                                alt="attachment" class="my-75" width="100"> <br>
                                                            <a href="#" id="{{ $key }}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="english_level" id=""
                                                        ...
                                                        <option value="Basic"
                                                            {{ $service->english_level == 'Basic' ? 'selected' : null }}>
                                                            Basic Level</option>
                                                        <option value="Bilingual"
                                                            {{ $service->english_level == 'Bilingual' ? 'selected' : null }}>
                                                            Bilingual Level</option>
                                                        <option value="Fluent"
                                                            {{ $service->english_level == 'Fluent' ? 'selected' : null }}>
                                                            Fluent Level</option>
                                                        <option value="Professional"
                                                            {{ $service->english_level == 'Professional' ? 'selected' : null }}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="service_category" id=""
                                                        ...
                                                        @foreach ($categories as $category)
                                                            <option
                                                                {{ $service->service_category == $category->id ? 'selected' : null }}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="type" id="" class="select2 form-control">
                                                        <option {{ $service->type == 'simple' ? 'selected' : null }}
                                                            value="simple">Simple</option>
                                                        <option {{ $service->type == 'featured' ? 'selected' : null }}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input"
                                                            name="attachment[]" id="inputGroupFile01">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="map-search"
                                                        name="location" value="{{ $service->location }}"> <br>
                        ...
                        <div class="tab-pane" id="tab32" role="tabpanel" aria-labelledby="base-tab32">
                            <div class="container">
                                @include(
                                    'UserAuthScreens.services_proposals.freelancer.pending_offers.pending_offers',
                                    [$pending_offers]
                                )
                            </div>
                        </div>
                        <div class="tab-pane" id="tab33" role="tabpanel" aria-labelledby="base-tab33">
                            <p>Biscuit ice cream halvah candy canes bear claw ice cream cake chocolate bar donut. Toffee
