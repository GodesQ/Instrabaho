                                        ...
                                        <tr>
                                            <td>
                                                <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <a href="/freelancer/edit_service/{{ $service->id }}"
                                                            class="btn btn-outline-primary btn-sm mr-50"><i
                                                                class="fa fa-edit"></i> View</a>
                                                        <button id="{{ $service->id }}"
                                                            class="delete-service btn btn-outline-danger btn-sm"><i
                                            ...
                                            <td>
                                                <h3 style="font-size: 15px;">
                                                    {{ date_format(new DateTime($service->created_at), 'F d, Y') }}</h3>
                                            </td>
                                            <td>
                                                <h3 style="font-size: 15px;">
                                                    {{ date_format(new DateTime($service->expiration_date), 'F d, Y') }}
                                                </h3>
                                            </td>
                                            <td valign="center">
