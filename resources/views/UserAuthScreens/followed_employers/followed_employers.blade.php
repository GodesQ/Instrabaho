                                ...
                                <tbody>
                                    @forelse($followed_employers as $followed_employer)
                                        <tr style="border-bottom: 1px solid #e3ebf3;">
                                                ...
                                                <div class="d-flex justify-content-start align-items-center"
                                                    ...
                                                    @if ($followed_employer->employer->user->profile_image)
                                                        <img style="border-radius: 50px;"
                                                            src="../../../images/user/profile/{{ $followed_employer->employer->user->profile_image }}"
                                                            alt="" width="40">
                                                    @else
                                                        <img style="border-radius: 50px;"
                                                    ...
                                                    <div>
                                                        <div class="font-weight-bold">
                                                            {{ $followed_employer->employer->display_name }}</div>
                                            ...
                                            <td class="40%">
                                                {{ date_format(new DateTime($followed_employer->employer->created_at), 'F d, Y') }}
                                            </td>
                                            <td>
                                                <a href="/employer/{{ $followed_employer->employer->user_id }}"
                                                    class="btn btn-sm btn-outline-primary"><i class="fa fa-eye"></i></a>
                                                <a href="/follow_employer/{{ $followed_employer->employer->id }}"
