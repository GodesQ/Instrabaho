            ...
            <div class="page-body">
                <div class="container">
                    <div class="my-1">
                        ...
                        @else
                            <a href="/employer/projects/info/{{ $project_offer->project->title }}"
                            ...
                            <ul class="nav nav-tabs nav-underline no-hover-bg nav-justified" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="active-tab32" data-toggle="tab" href="#active32"
                                        aria-controls="active32" role="tab" aria-selected="true">Project Info</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="link-tab32" data-toggle="tab" href="#link32"
                                        aria-controls="link32" role="tab" aria-selected="false">Message</a>
                                </li>
                            </ul>
                            <div class="tab-content px-1 pt-1">
                                <div class="tab-pane active in" id="active32" aria-labelledby="active-tab32"
                                    role="tabpanel">
                                    <div class="container py-2">
                                        <div class="text-right my-1">
                                            @if (session()->get('role') == 'freelancer' && !$project_offer->is_freelancer_approve)
                                                <button id="{{ $project_offer->id }}"
                                                    class="btn btn-success accept-offer-btn">Accept Offer</button>
                                            @endif

                                            @if (session()->get('role') == 'employer' &&
                                                    $project_offer->is_freelancer_approve &&
                                                    !$project_offer->status == 'pending')
                                                <a href="/project/create-contract/offer/{{ $project_offer->id }}"
                                                    class="btn btn-success">Hire Worker</a>
                                            @endif
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                    {{ date_format(new DateTime($project_offer->project->created_at), 'F d, Y') }}
                                                </div>
                                            </div>
                                        </div>
                                        {{-- <div class="my-2">
                                        ...
                                        <div>
                                            ...
                                            <h6>{{ date_format(new DateTime($project_offer->project->start_date), 'F d, Y') }}
                                                -
                                                {{ date_format(new DateTime($project_offer->project->end_date), 'F d, Y') }}
                                            </h6>
                                        </div>
                                        <div class="my-1">
                                            ...
                                            <div class="d-flex flex-wrap gap-10">
                                                @forelse (json_decode($project_offer->project->attachments) as $attachment)
                                                    <a href="{{ '../../../images/projects/' . $attachment }}"
                                                        target="_blank"
                                                        class="d-flex justify-content-between align-items-center p-50 border">
                                                        <img src="../../../images/projects/{{ $attachment }}"
                                                            style="width: 80px !important; height: 100% !important;"
                                    ...
                                    <div class="container py-2">
                                        ...
                                        <div class="my-1">
                                            ...
                                            {{ $project_offer->project->employer->user->firstname . ' ' . $project_offer->project->employer->user->lastname }}
                                        </div>
                                        <div class="my-1">
                                            <span class="font-weight-bold">Display Name :</span>
                                            {{ $project_offer->project->employer->display_name }}
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <section class="chat-area">
                                            ...
                                            <form action="#" class="typing-area">
                                                ...
                                                <input type="text" name="message" class="input-field"
                                                    id="message_input" placeholder="Type a message here..." />
