                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-sm-12 my-2">
                                            <div class="form-group">
                                                <div class="form-label font-weight-bold" style="color: #000 !important;">
                                                    What Project do you want to offer?</div>
                                        ...
                                        <div class="col-lg-12 my-2">
                                            <div class="form-group">
                                                <div class="form-label font-weight-bold" style="color: #000 !important;">Any
                                                    Private Message to Freelancer?</div>
                                                <textarea name="private_message" id="private_message" cols="30" rows="10" class="form-control"
                                                    placeholder="Send Private Message to Freelancer"></textarea>
                                            </div>
                                        </div>
                ...
                <div class="col-lg-3">
                    <div class="fr-project-f-profile">
                        <div class="fr-project-f-product">
                            <div class="fr-project-f-fetured"> <a href=""><img
                                        src="../../../images/user/profile/{{ $freelancer->user->profile_image }}"
                                        style="height: 100px !important; object-fit: cover !important;" alt=""
                                        class="img-fluid"></a> </div>
                        </div>
                        <div class="fr-project-f-user-details">
                            <a href="">
                                <h3><i class="fa fa-check protip" data-pt-position="top" data-pt-scheme="black"
                                        data-pt-title=" Verified" aria-hidden="true"></i>{{ $freelancer->display_name }}
                                </h3>
                            </a>
                    ...
                    <div class="fr-project-f-employers">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="fr-project-method"> <i class="fal fa-check-square" aria-hidden="true"></i>
                                    <span>{{ $freelancer->tagline }}</span> </div>
                            </li>
                        </ul>
                    </div>
                </div>
