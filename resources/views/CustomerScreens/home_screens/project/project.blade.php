...
@section('content')
                                    ...
                                    <ul class="">
                                        <li>
                                            ...
                                            <div>
                                                ...
                                                <strong>{{ date_format(new DateTime($project->start_date), 'M d, Y') }} -
                                                    {{ date_format(new DateTime($project->end_date), 'M d, Y') }} </strong>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div>
                                                ...
                                                <strong>₱ {{ number_format($project->total_cost, 2) }}
                                                    ({{ $project->project_cost_type }})</strong>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="attacment-box">
                                    ...
                                    @foreach ($attachments as $attachment)
                                        <div class="attachments">
                                            ...
                                            <a target="_blank" href="{{ '../../../images/projects/' . $attachment }}"
                                                class="download-icon"><i class="fas fa-eye"></i></a>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                <div class="fr-project-place" id="fr-bid-form">
                                    ...
                                    <form method="POST" action="/store_proposal" enctype="multipart/form-data">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-xl-6 col-sm-12">
                                                <div class="form-group">
                                                    <label style="font-size: 18px !important;"> Project Cost Type <span
                                                            class="text-danger">*</span></label>
                                                    <select name="project_cost_type" class="form-control"
                                                        id="project_cost_type">
                                                        <option
                                                            {{ $project->project_cost_type == 'Fixed' ? 'selected' : null }}
                                                            value="Fixed">Fixed</option>
                                                        <option
                                                            {{ $project->project_cost_type == 'Hourly' ? 'selected' : null }}
                                        ...
                                        <div class="form-row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label style="font-size: 18px !important;">Address <span
                                                            class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <input type="text" multiple class="form-control"
                                                            id="map-search" name="address">
                                                        <div class="input-group-prepend">
                                                            <button class="btn btn-primary" type="button"
                                                                id="get-current-location">Current Location</button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-12">
                                                <label style="font-size: 18px !important;"> Proposal Description <span
                                                        class="text-info text-italic"
                                                        style="font-size: 15px !important;">(Optional)</span></label>
                                                <textarea class="form-control" id="bid-textarea" name="cover_letter" rows="5"></textarea>
                                            </div>
                                            <div class="col-12 my-3">
                                                <div class="form-group">
                                                    <label style="font-size: 18px !important;">Attachments <span
                                                            class="text-info text-italic"
                                                            style="font-size: 15px !important;">(Optional)</span></label>
                                                    <div class="input-group">
                                                        <input type="file" class="form-control" name="attachments[]"
                                                            id="inputGroupFile01">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text"><i class="fa fa-image"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <button type="submit" class="btn btn-theme btn-loading"
                                                    id="btn_project_bid" data-post-id="225">Submit Proposal</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div class="project-sidebar position-sticky">
                        <div class="fr-project-f-profile">
                            <div class="fr-project-f-product">
                                <div class="fr-project-f-fetured"> <a href="">
                                        @if ($project->employer->user->profile_image)
                                            <img src="../../../images/user/profile/{{ $project->employer->user->profile_image }}"
                                                style="width: 100px; height: 100px !important; object-fit: cover !important;"
                                                alt="" class="img-fluid">
                                    </a>
                                @else
                            ...
                            <div class="fr-project-f-user-details">
                                <a href="">
                                    <h3><i class="fa fa-check protip" data-pt-position="top" data-pt-scheme="black"
                                            data-pt-title=" Verified"
                                            aria-hidden="true"></i>{{ $project->employer->display_name }}</h3>
                                </a>
                                <span>Member since
                                    {{ date_format(new DateTime($project->employer->created_at), 'F d, Y') }}</span>
                            </div>
                        ...
                        <div class="fr-project-f-employers">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="fr-project-method"> <i class="fal fa-check-square"
                                            aria-hidden="true"></i> <span>{{ $project->employer->tagline }}</span> </div>
                                </li>
                            </ul>
                        </div>
                        <div class="fl-advert-box">
                        ...
                        <p class="report-button text-center">
                            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#report-modal"><i
                                    class="fas fa-exclamation-triangle"></i>Report Project</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade forget_pwd show" id="report-modal" data-backdrop="static" data-keyboard="false"
                        ...
                        <div class="fr-report-form">
                            <div class="form-group">
                                ...
                                <select name="report_category"
                                    class="form-control general_select select2-hidden-accessible" tabindex="-1"
                                    aria-hidden="true">
                                    <option value="357">
                                        Duplicate
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" id="btn-report" class="btn btn-theme btn-loading btn-report"
                                    data-post-id="225 ">Save &amp; Submit<span class="bubbles"> <i class="fa fa-circle"
                                            aria-hidden="true"></i> <i class="fa fa-circle" aria-hidden="true"></i> <i
                                            class="fa fa-circle" aria-hidden="true"></i> </span></button>
                            </div>
                        </div>
                    </div>
                </form>
