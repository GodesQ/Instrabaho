   ...
   <section class="fr-services2-details padding-top-bottom-2">
      <div class="container">
         <div class="row">
                                ...
                                <div class="flex-viewport">
                                    <ul class="slides">
                                        ...
                                        <li class="clone " aria-hidden="true">
                                            <a data-fancybox="services" href="../../../images/services/{{ $image }}" target="_blank"><img style="width: 100%; min-height: 300px !important; max-height: 400px; object-fit: cover;" src="../../../images/services/{{ $image }}" draggable="false"></a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
                            ...
                            <div class="fr-seller-servives">
                               ...
                               <div class="fr-seller-servives-meta">
                                  ...
                                  <div class="fr-seller-details">
                                     <a href="/freelancer/view/{{ $service->freelancer->display_name }} "><span><i class="fa fa-check" aria-hidden="true"></i>{{ $service->freelancer->display_name }}</span></a>
                                     <h3>{{ $service->freelancer->tagline }}</h3>
                                     <div class="fr-seller-rating">
                                        No Reviews
                                     </div>
                                  </div>
                                  <div class="fr-seller-view"> <a href="/freelancer/view/{{ $service->freelancer->display_name }}" class="btn btn-theme">View Profile</a> </div>
                               </div>
                            </div>
            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class=" project-price service p-2 d-flex justify-content-center align-items-center text-white" style="margin-bottom: 0px !important;">
                           ...
                           <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="estimated_start_date" class="form-control" id="estimated_start_date">
                                     </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Estimated Finish Date</label>
                                        <input type="date" name="estimated_finish_date" class="form-control" id="estimated_finish_date">
                                     </div>
                                </div>
                           </div>
                           <div class="form-group">
