                            ...
                            <form action="#" id="services-filter-form">
                                <div class="panel panel-default">
                                    <div class="panel-heading active"> <a role="button" class=""
                                            data-bs-toggle="collapse" href="#search-widget"> Keywords </a> </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading active"> <a role="button" class="collapsed"
                                            data-bs-toggle="collapse" href="#freelancer-location">Location </a> </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="address" id="map-search"
                                                            class="form-control controls" value="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading active"> <a role="button" class=""
                                            data-bs-toggle="collapse" href="#category-widget"> Search by category </a>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading active"> <a role="button" class=""
                                            data-bs-toggle="collapse" href="#type-widget"> Type </a> </div>
                                    ...
                                    <div class=" float-right">
                                        <ul class="top-filters">
                                            ...
                                            <button type="button" class="btn btn-primary view-map-btn"
                                                data-toggle="modal" style="display: none;" data-target="#create">
                                                View Map
                                            </button>
                                        </ul>
                                    </div>
